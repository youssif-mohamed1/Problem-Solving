...
void sieve(int sz) { composite[0] = composite[1] = 1; for (int i = 2; i * i < sz; i++) { if (!composite[i]) { for (int j = i * i; j < sz; j += i) { composite[j] = 1; } } } } // nlog(log(n))
//==================================================Black Boxes===============================================================================================================================================================================================
//
